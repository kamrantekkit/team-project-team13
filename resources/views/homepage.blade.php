        ...
        <div class="container" style="min-height: 400px;">
            <div class="row justify-content-center">
                ...
                <div class="col-md-4 text-center" style="margin-top: 30px;">
                    ...
                    <img class="img-fluid" src="{{secure_asset("assets/img/Screenshot%202023-11-22%20013112.png")}}" alt="Nintendo img"/>
                </div>
                <!-- Xbox button and images -->
                <div class="col-md-4 text-center" style="margin-top: 30px;">
                    <a href="{{route('products',['Xbox'])}}" class="btn mb-4" style="width: 70%; background-color: #127D10; color: #ffffff;">Xbox
                    </a>
                    <img class="img-fluid" src="{{secure_asset("assets/img/Screenshot%202023-11-22%20025302.png")}}" alt="Xbox img"/>
                </div>
                ...
                <div class="col-md-4 text-center" style="margin-top: 30px;">
                    ...
                    <img class="img-fluid" src="{{secure_asset("assets/img/Screenshot%202023-11-22%20025327.png")}}" alt="Playstation img"/>
                </div>
                <!-- PC button and images -->
                <div class="col-md-4 text-center" style="margin-top: 30px;">
                    <a href="{{route('products',['PC'])}}" class="btn mb-4" style="width: 70%; background-color: #225B7C; color: #ffffff;">PC</a>
                    <img class="img-fluid" src="{{secure_asset("assets/img/Screenshot%202023-11-22%20031453.png")}}" style="width: 300px;"
                         alt="PC img"/>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid text-center"
            ...
            <div class="row justify-content-evenly align-items-center h-100">
                <div class="col-md-3 mb-3" style="margin-top: -420px;">
                    <img src="{{secure_asset("assets/img/Screenshot%202023-11-27%20231603.png")}}" style="width: 175px;"/>
                </div>
                <div class="col-md-3 mb-3" style="margin-top: -420px;">
                    <img src="{{secure_asset("assets/img/Screenshot%202023-11-27%20231542.png")}}" style="width: 175px;"/>
                </div>
                <div class="col-md-3 mb-3" style="margin-top: -420px;">
                    <img src="{{secure_asset("assets/img/Screenshot%202023-11-27%20214411.png")}}" style="width: 175px;"/>
                </div>
            </div>
        </div>
