...
<div><img id="imageSwitch" src="assets/img/Funko-Pokemon-db.webp"
    ...
    <div style="background: rgb(250,250,245);margin-bottom: 100px;margin-top: 400px;color: rgb(250,250,245);">
        <div class="container" style="min-height: 400px;background: rgb(250,250,245);">
            <div class="row justify-content-center">
                ...
                <div class="col-md-4 text-center" style="margin-top:30px;">
                    ...
                    <img class="img-fluid" src="assets/img/Screenshot%202023-11-22%20025302.png" alt="Xbox img"></div>
        ...
        <div class="container-fluid text-center"
            ...
            <div class="row justify-content-evenly align-items-center h-100"
                 style="color: rgb(250,250,245);background: rgb(250,250,245);">
                <div class="col-md-3 mt-4"><a class="btn btn-primary w-100 mb-3" role="button" href="#"
            ...
            <div class="row justify-content-evenly align-items-center h-100" style="background: rgb(250,250,245);">
                <div class="col-md-3 mb-3" style="margin-top:-420px;"><img
                        src="assets/img/Screenshot%202023-11-27%20231603.png" style="width:175px;"></div>
                <div class="col-md-3 mb-3" style="margin-top:-420px;"><img
                        src="assets/img/Screenshot%202023-11-27%20231542.png" style="width:175px;"></div>
                <div class="col-md-3 mb-3" style="margin-top:-420px;"><img
                        src="assets/img/Screenshot%202023-11-27%20214411.png" style="width:175px;"></div>
            </div>
        </div>
