                ...
                <div class="col-md-6 d-flex justify-content-start align-items-center">
                    ...
                    <div class="card rounded"
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <a class="btn btn-dark my-2" role="button" href="{{route('dashboard')}}"
                               style="height:38px;">Your Orders</a>
                            <a class="btn btn-dark my-2" role="button" href="#" style="height:38px;">Favorites</a>
                            <a class="btn btn-dark my-2" role="button" href="{{route('dashboard.settings')}}"
                               style="height:38px;">My Profile</a>
                            ...
                            @if(auth()->user()->is_admin)
                                <a class="btn btn-dark my-2" role="button" href="{{route('admin.dashboard')}}"
                                   style="height:38px;">Go To Admin Board</a>
                            @endif
