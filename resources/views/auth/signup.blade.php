                    ...
                    <div class="card bg-white shadow-lg" style="border: none">
                        <div class="card-body">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <input type="text" placeholder="Name" class="form-control mt-3  @error('name') is-invalid @enderror" name="name"
                                ...
                                @enderror
                                <input type="email" placeholder="E-mail" class="form-control mt-3 @error('email') is-invalid @enderror"
